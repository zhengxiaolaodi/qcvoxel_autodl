...
for i in range(len(names)):
    ...
    if names[i] == "南京市":
       questiong_make_6(csv_name,names[i],str_nanjing)
    elif names[i] == "淮安市":
       questiong_make_6(csv_name,names[i],str_huaian)
    elif names[i] == "苏州市":
       questiong_make_7(csv_name,names[i],str_suzhou)
    elif names[i] == "常州市":
       questiong_make_7(csv_name,names[i],str_changzhou)
    elif names[i] == "盐城市":
       questiong_make_yanc(csv_name,names[i],str_yanchen)
    elif names[i] == "连云港市":
       questiong_make_7(csv_name,names[i],str_lianyungang,start=3)
    else:
       questiong_make_5(csv_name,names[i],str_else)
